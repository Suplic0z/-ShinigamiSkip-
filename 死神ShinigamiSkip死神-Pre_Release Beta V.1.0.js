// ==UserScript==
// @name         死神ShinigamiSkip Ultimate
// @namespace    https://github.com/Suplic0z/-ShinigamiSkip-
// @description  Skip intro/outro + auto next + memoria serie + connessioni API + statistiche + cloud sync - Versione Completa
...
(function() {
    ...
    class SkipDatabase {
        ...
        incrementVerified(seriesKey, episode, type, version = 'default', quality = '1080p') {
            ...
            if (data && data.skipInfo && data.skipInfo[type]) {
                ...
                if (type === 'outro') this.stats.outroSkips++;
    ...
    class SkipManager {
        ...
        destroy() {
            ...
            if (this.state.autoNextTimer) {
                clearTimeout(this.state.autoNextTimer);
            }
        }
    }
    ...
    class UIController {
        constructor(skipManager) {
            ...
            this.isCompactMode = CONFIG.UI.COMPACT_MODE;
            this.createUI();
            this.attachHotkeys();
            ...
            panel.innerHTML = `
                <div class="shinigami-header" id="shinigami-drag-handle">
                    ...
                    <div class="shinigami-actions">
                        ...
                        <button id="shinigami-compact-btn" class="icon-btn" title="Modalità compatta">📱</button>
        ...
        createSettingsPanel() {
            const panel = document.createElement('div');
            panel.id = 'shinigami-settings-panel';
            panel.className = 'hidden';
            panel.innerHTML = `
                <div class="settings-header">
                    <h3>⚙️ Impostazioni ShinigamiSkip</h3>
                ...
                <div class="settings-content">
                    <div class="settings-section">
                        ...
                        <div class="setting-item">
                            <label class="setting-label">
                                <input type="checkbox" id="setting-auto-next" ${this.skipManager.settings.autoNextEpisode ? 'checked' : ''}>
                                <span class="setting-text">Auto Passaggio Episodio</span>
                            </label>
                        </div>
                        <div class="setting-item">
                            <label class="setting-label">
                                <input type="checkbox" id="setting-smart-learning" ${this.skipManager.settings.smartLearning ? 'checked' : ''}>
                                <span class="setting-text">Smart Learning</span>
                            </label>
                        </div>
                        <div class="setting-item">
                            <label class="setting-label">
                                <input type="checkbox" id="setting-predictive-skip" ${this.skipManager.settings.predictiveSkip ? 'checked' : ''}>
                                <span class="setting-text">Predictive Skip</span>
                            </label>
                        </div>
                        <div class="setting-item">
                            <label class="setting-label">
                                <input type="checkbox" id="setting-skip-recap" ${this.skipManager.settings.skipRecap ? 'checked' : ''}>
                                <span class="setting-text">Skip Recap</span>
                            </label>
                        </div>
                        <div class="setting-item">
                            <label class="setting-label">
                                <input type="checkbox" id="setting-skip-preview" ${this.skipManager.settings.skipPreview ? 'checked' : ''}>
                                <span class="setting-text">Skip Preview</span>
                            </label>
                        </div>
                        <div class="setting-item">
                            <label class="setting-label">
                                <input type="checkbox" id="setting-add-seconds" ${this.skipManager.settings.addSecondsMode ? 'checked' : ''}>
                                <span class="setting-text">Modalità Add Seconds</span>
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="setting-item">
                            <label class="setting-label">
                                ...
                                <select id="setting-theme" class="setting-select">
                                    <option value="dark" ${CONFIG.UI.THEME === 'dark' ? 'selected' : ''}>Scuro</option>
                                    <option value="light" ${CONFIG.UI.THEME === 'light' ? 'selected' : ''}>Chiaro</option>
                                    <option value="auto" ${CONFIG.UI.THEME === 'auto' ? 'selected' : ''}>Automatico</option>
                                </select>
                            </label>
                        </div>
                        <div class="setting-item">
                            <label class="setting-label">
                                <span class="setting-text">Posizione</span>
                                <select id="setting-position" class="setting-select">
                                    <option value="bottom-right" ${CONFIG.UI.POSITION === 'bottom-right' ? 'selected' : ''}>In basso a destra</option>
                                    <option value="bottom-left" ${CONFIG.UI.POSITION === 'bottom-left' ? 'selected' : ''}>In basso a sinistra</option>
                                    <option value="top-right" ${CONFIG.UI.POSITION === 'top-right' ? 'selected' : ''}>In alto a destra</option>
                                    <option value="top-left" ${CONFIG.UI.POSITION === 'top-left' ? 'selected' : ''}>In alto a sinistra</option>
                                </select>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="settings-section">
                        <h4>Tempi Fallback</h4>
                        <div class="setting-item">
                            <label class="setting-label">
                                <span class="setting-text">Intro (secondi)</span>
                                <input type="number" id="setting-intro-fallback" min="5" max="300" value="${this.skipManager.settings.introFallback}" class="setting-number">
                            </label>
                        </div>
                        <div class="setting-item">
                            <label class="setting-label">
                                <span class="setting-text">Outro (secondi)</span>
                                <input type="number" id="setting-outro-fallback" min="5" max="300" value="${this.skipManager.settings.outroFallback}" class="setting-number">
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="settings-section">
                        ...
                        <div class="hotkey-list">
                            <div class="hotkey-item">
                                <span class="hotkey-desc">Skip Intro</span>
                                <kbd class="hotkey-key">${CONFIG.HOTKEYS.SKIP_INTRO.toUpperCase()}</kbd>
                            </div>
                            <div class="hotkey-item">
                                <span class="hotkey-desc">Skip Outro</span>
                                <kbd class="hotkey-key">${CONFIG.HOTKEYS.SKIP_OUTRO.toUpperCase()}</kbd>
                            </div>
                            <div class="hotkey-item">
                                <span class="hotkey-desc">Toggle Auto Skip</span>
                                <kbd class="hotkey-key">${CONFIG.HOTKEYS.TOGGLE_AUTO.toUpperCase()}</kbd>
                            </div>
                            <div class="hotkey-item">
                                <span class="hotkey-desc">Toggle Learn Mode</span>
                                <kbd class="hotkey-key">${CONFIG.HOTKEYS.TOGGLE_LEARN.toUpperCase()}</kbd>
                            </div>
                            <div class="hotkey-item">
                                <span class="hotkey-desc">Apri/Chiudi Pannello</span>
                                <kbd class="hotkey-key">${CONFIG.HOTKEYS.OPEN_PANEL.toUpperCase()}</kbd>
                            </div>
                            <div class="hotkey-item">
                                <span class="hotkey-desc">Prossimo Episodio</span>
                                <kbd class="hotkey-key">${CONFIG.HOTKEYS.NEXT_EPISODE.toUpperCase()}</kbd>
                            </div>
                            <div class="hotkey-item">
                                <span class="hotkey-desc">Episodio Precedente</span>
                                <kbd class="hotkey-key">${CONFIG.HOTKEYS.PREVIOUS_EPISODE.toUpperCase()}</kbd>
                            </div>
                            <div class="hotkey-item">
                                <span class="hotkey-desc">Toggle Fullscreen</span>
                                <kbd class="hotkey-key">${CONFIG.HOTKEYS.TOGGLE_FULLSCREEN.toUpperCase()}</kbd>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="settings-actions">
                    <button id="save-settings-btn" class="shinigami-btn primary">
                        💾 Salva Impostazioni
                    </button>
                    <button id="reset-settings-btn" class="shinigami-btn secondary">
        ...
        attachUIListeners() {
            ...
            // Compact mode
            document.getElementById('shinigami-compact-btn')?.addEventListener('click', () => {
        ...
        attachSettingsListeners() {
            ...
            document.getElementById('setting-auto-next')?.addEventListener('change', (e) => {
                this.skipManager.updateSettings('autoNextEpisode', e.target.checked);
            });

            document.getElementById('setting-smart-learning')?.addEventListener('change', (e) => {
                this.skipManager.updateSettings('smartLearning', e.target.checked);
            });

            document.getElementById('setting-predictive-skip')?.addEventListener('change', (e) => {
                this.skipManager.updateSettings('predictiveSkip', e.target.checked);
            });

            document.getElementById('setting-skip-recap')?.addEventListener('change', (e) => {
                this.skipManager.updateSettings('skipRecap', e.target.checked);
            });

            document.getElementById('setting-skip-preview')?.addEventListener('change', (e) => {
                this.skipManager.updateSettings('skipPreview', e.target.checked);
            });

            document.getElementById('setting-add-seconds')?.addEventListener('change', (e) => {
                this.skipManager.updateSettings('addSecondsMode', e.target.checked);
            });

            document.getElementById('setting-theme')?.addEventListener('change', (e) => {
                CONFIG.UI.THEME = e.target.value;
                this.updateTheme();
            });

            document.getElementById('setting-position')?.addEventListener('change', (e) => {
                CONFIG.UI.POSITION = e.target.value;
                this.updatePanelPosition();
            });

            document.getElementById('setting-intro-fallback')?.addEventListener('change', (e) => {
                this.skipManager.updateSettings('introFallback', parseInt(e.target.value));
            });

            document.getElementById('setting-outro-fallback')?.addEventListener('change', (e) => {
                this.skipManager.updateSettings('outroFallback', parseInt(e.target.value));
            });
        ...
        attachHotkeys() {
            ...
            document.addEventListener('keydown', (e) => {
                ...
                } else if (key === CONFIG.HOTKEYS.PREVIOUS_EPISODE) {
                    e.preventDefault();
        ...
        updatePanelPosition() {
            ...
            panel.classList.add(`position-${CONFIG.UI.POSITION}`);
        }
        ...
        toggleCompactMode() {
            ...
            if (panel) {
                panel.classList.toggle('compact', this.isCompactMode);
            }
        }
        ...
        toggleStats() {
            ...
            if (statsPanel) {
                ...
                const settingsPanel = document.getElementById('shinigami-settings-panel');
        ...
        injectStyles() {
            ...
            style.textContent = `
                ...
                #shinigami-panel {
                    ...
                    bottom: 80px;
                    right: 20px;
                    background: ${isDark ? 'linear-gradient(145deg, rgba(15, 15, 25, 0.98), rgba(25, 25, 40, 0.98))' : 'linear-gradient(145deg, rgba(255, 255, 255, 0.98), rgba(240, 240, 245, 0.98))'};
                    border: 2px solid ${isDark ? '#ff6b6b' : '#ff5252'};
                    border-radius: 16px;
                    padding: 0;
                    z-index: 999999;
                    ...
                    box-shadow: 0 20px 60px rgba(0, 0, 0, 0.8),
                                0 0 0 1px ${isDark ? 'rgba(255, 107, 107, 0.2)' : 'rgba(255, 82, 82, 0.2)'};
                ...
                #shinigami-panel:hover {
                    box-shadow: 0 25px 70px rgba(0, 0, 0, 0.9),
                                0 0 0 2px ${isDark ? 'rgba(255, 107, 107, 0.4)' : 'rgba(255, 82, 82, 0.4)'};
                    transform: translateY(-2px);
                }

                #shinigami-panel.compact {
                    min-width: 280px;
                    max-width: 300px;
                }

                #shinigami-panel.compact .episode-info {
                    margin-bottom: 10px;
                }

                #shinigami-panel.compact .shinigami-controls {
                    margin-bottom: 10px;
                }

                #shinigami-panel.compact .shinigami-toggles {
                    margin-bottom: 10px;
                }

                #shinigami-panel.compact .skip-info-panel {
                    margin-bottom: 10px;
                }

                /* Position classes */
                #shinigami-panel.position-top-right {
                    top: 20px;
                    bottom: auto;
                    right: 20px;
                }

                #shinigami-panel.position-top-left {
                    top: 20px;
                    bottom: auto;
                    left: 20px;
                    right: auto;
                ...
                #shinigami-panel.position-bottom-left {
                    bottom: 80px;
                    right: auto;
                    left: 20px;
                }
                ...
                #shinigami-settings-panel.hidden {
                    opacity: 0;
                    pointer-events: none;
                    transform: translate(-50%, -50%) scale(0.9);
                }
                ...
                .settings-actions .shinigami-btn {
                    flex: 1;
                }
                ...
                @media (max-width: 768px) {
                    ...
                    #shinigami-stats-panel, #shinigami-settings-panel {
                        min-width: 90%;
                        max-width: 95%;
                    }
    ...
    async function init() {
        ...
        db.updateSessionStats();
        
        // Inizializza skip manager
        const skipManager = new SkipManager(player, episodeInfo, db);
        await skipManager.init();

        // Crea UI
        const ui = new UIController(skipManager);

        // Salva riferimenti globali
        STATE.player = player;
        STATE.db = db;
        STATE.skipManager = skipManager;
        STATE.ui = ui;
...
✓ Database locale e sync remota
✓ Import/Export dati
✓ Skip recap e preview
✓ Smart learning
✓ Predictive skip
✓ Modalità add seconds
